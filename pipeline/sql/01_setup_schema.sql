...
CREATE OR REPLACE TABLE BRONZE.EMPLOYEE_RAW (
    ...
    DAYS_SINCE_LAST_1ON1  VARCHAR,
    PTO_DAYS_UNUSED       VARCHAR,
    INTERNAL_TRANSFERS_REQUESTED VARCHAR,
    TEAM_SIZE           VARCHAR,
...
CREATE OR REPLACE TABLE SILVER.EMPLOYEE_CLEANSED (
    ...
    DAYS_SINCE_LAST_1ON1    NUMBER(5,0),
    PTO_DAYS_UNUSED         NUMBER(3,0),
    INTERNAL_TRANSFERS_REQUESTED NUMBER(1,0),
